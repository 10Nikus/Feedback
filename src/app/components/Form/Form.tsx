  ...
  return (
    <form className="bg-white p-10  flex flex-col gap-8">
      ...
      <div>
        ...
        <input type="text" className="bg-slate-200 w-full py-2 rounded-md" />
      </div>
      <div>
        <h1 className="font-bold">Category</h1>
        <p>Choose a category for your feedback</p>
        <select className="bg-slate-200 w-full py-2 rounded-md">
      ...
      <div>
        ...
        <textarea className="bg-slate-200 w-full py-2 rounded-md" />
      </div>
