...
export const FeedbackList = () => {
  ...
  return (
    <div className="hidden sm:flex flex-col align-middle w-full items-center min-h-svh">
      {loading && <FeedbackItemListSkeleton />}
      {feedbacks &&
        feedbacks.map((f: any) => (
          <FeedbackListItem key={f._id} feedback={f} isDetail={false} />
        ))}
      <div className="bg-white rounded-md w-full flex flex-col items-center py-40 gap-6">
        ...
        <div>
          <p className="text-sm">
            Got a suggestion? Found a bug Found a bug that needs to be squashed?
          </p>
          <p className="textsm">
