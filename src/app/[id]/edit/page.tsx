...
import CancelBtn from "@/app/components/Form/CancelBtn";
import FeedbuckButton from "@/app/components/Header/FeedbackButton";
...
export default function Edit() {
  ...
  return (
    <form className="bg-white p-10  flex flex-col gap-8">
      <h1 className="font-bold text-5xl">Edit Feedback</h1>
      <div>
      ...
      <div className="flex justify-end gap-2">
        <CancelBtn />
        <FeedbuckButton link={`/${id}`} title="Edit" />
      </div>
    </form>
  );
}
